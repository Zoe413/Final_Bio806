...
legend_data <- data.frame(
  ...
  Location = c("Fulfilled Estimated 'Geneva 3' Chill Requirement", "Did Not Fulfill Chill Requirement")
)
...
ggplot(mystates, aes(long, lat)) +
  ...
  geom_text_repel(data = together, aes(x = long, y = lat, label = Name), size = 3) +
  scale_color_identity()+
  ggtitle("Locations that reached 45 Chill Portions Winter 2023-24")+
  xlab("Longitude")+
  ylab("Latitude")+
  geom_point(data = legend_data, aes(x = long, y = lat, color = ifelse(ChillPortions > 45, "green", "red")), pch = 16, size = 3) +
  geom_text(data = legend_data, aes(x = long, y = lat, label = Location), vjust = -1, size = 3)+
  theme(
